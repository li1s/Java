...
public class Game_Snake {

	final String TITLE_OF_PROGRAM = "Classic game SNAKE";
	final String GAME_OVER_MSG = "GAME OVER";
	final int POINT_RADIUS = 20;
	final int FIELD_WIDHT = 30;
	...
	void go() {
		...
		frame.setSize(FIELD_WIDHT * POINT_RADIUS + FIELD_DX, FIELD_HEIGHT * POINT_RADIUS + FIELD_DY);
	...
	public class Canvas extends JPanel {
		...
		public void paint(Graphics g) {
			...
			if (gameOver) {
				...
				g.setFont(new Font("Arrial", Font.BOLD, 40));
				FontMetrics fm = g.getFontMetrics();
				g.drawString(GAME_OVER_MSG, (FIELD_WIDHT * POINT_RADIUS + FIELD_DX - fm.stringWidth(GAME_OVER_MSG)) / 2,
